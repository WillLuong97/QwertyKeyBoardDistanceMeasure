...
import keyboard.AppleNumericMB110LLKeyboardMetricsImpl_Luong;
import keyboard.Key;
...
public class KeyboardLayoutAllTests_Luong 
{
	private static KeyboardMetrics getKeyboardMetrics(KeyLayout keyLayout)
	{
		return new AppleNumericMB110LLKeyboardMetricsImpl_Luong(keyLayout);
	}
